...
function validate()  {
    ...
    if (nameinput.value === '' || nameinput.value == null){
        ...
        document.getElementById("error1").style.border="1px solid white";
        ...
        document.getElementById("error2").style.border="1px solid white";
        ...
        document.getElementById("error3").style.border="1px solid white";
